...
Go to the GitHub repo, click the green **Code** button and select **Download ZIP**. Extract the ZIP to a folder of your choice.

### 2. Run the application

Open a terminal inside the extracted folder, then:
